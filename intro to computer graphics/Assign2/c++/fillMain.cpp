...
void makePolygons( Rasterizer &R )
{
    ...
    x[1] = 740;  y[1] =  60;
    x[2] = 620;  y[2] =  60;
    R.C.setColor( 0.9f, 0.0f, 0.0f );//works
    R.drawPolygon( 3, x, y );
    ...
    x[1] = 560;  y[1] = 100;
    x[2] = 500;  y[2] = 180;
    R.C.setColor( 0.8f, 0.0f, 0.0f );//segfault?
    R.drawPolygon( 3, x, y );
    ...
    x[1] = 490;  y[1] = 280;
    x[2] = 420;  y[2] = 280;
    R.C.setColor( 0.0f, 1.0f, 0.0f );//works
    R.drawPolygon( 3, x, y );
    ...
    x[2] = 360;  y[2] = 380;
    x[3] = 420;  y[3] = 340;
    R.C.setColor( 0.0f, 0.8f, 0.8f );//aborts
    R.drawPolygon( 4, x, y );
    ...
    x[5] = 230;  y[5] = 460;
    x[6] = 230;  y[6] = 410;
    R.C.setColor( 0.8f, 0.8f, 0.0f );//aborts
    R.drawPolygon( 7, x, y );
    ...
    x[2] =  20;  y[2] =  20;
    x[3] =  20;  y[3] =   0;
    R.C.setColor( 0.0f, 0.0f, 1.0f );//works
    R.drawPolygon( 4, x, y );
    ...
    x[2] =  10;  y[2] = 580;
    x[3] =   0;  y[3] = 580;
    R.C.setColor( 0.0f, 0.1f, 0.9f );//works
    R.drawPolygon( 4, x, y );
    ...
    x[2] =  20;  y[2] = 599;
    x[3] =  20;  y[3] = 580;
    R.C.setColor( 0.0f, 0.2f, 0.8f );//works
    R.drawPolygon( 4, x, y );
    ...
    x[1] =  10;  y[1] = 599;
    x[2] = 880;  y[2] = 599;
    R.C.setColor( 0.0f, 0.3f, 0.7f );//works
    R.drawPolygon( 3, x, y );
    ...
    x[1] = 880;  y[1] = 590;
    x[2] = 880;  y[2] = 599;
    R.C.setColor( 0.0f, 0.4f, 0.6f );//works
    R.drawPolygon( 3, x, y );
    ...
    x[2] = 880;  y[2] = 580;
    x[3] = 880;  y[3] = 599;
    R.C.setColor( 0.1f, 0.4f, 0.5f );//works
    R.drawPolygon( 4, x, y );
    ...
    x[1] = 899;  y[1] = 580;
    x[2] = 890;  y[2] =  20;
    R.C.setColor( 0.2f, 0.4f, 0.4f );//works
    R.drawPolygon( 3, x, y );
    ...
    x[1] = 899;  y[1] =  20;
    x[2] = 890;  y[2] =  20;
    R.C.setColor( 0.3f, 0.4f, 0.3f );//works
    R.drawPolygon( 3, x, y );
    ...
    x[2] = 880;  y[2] =  20;
    x[3] = 880;  y[3] =   0;
    R.C.setColor( 0.4f, 0.4f, 0.2f );//works
    R.drawPolygon( 4, x, y );
    ...
    x[2] = 880;  y[2] =  10;
    x[3] = 880;  y[3] =   0;
    R.C.setColor( 0.4f, 0.5f, 0.1f );//works
    R.drawPolygon( 4, x, y );
}
